...
- **Evidence that measured predictive fitness discriminates dynamics shifts from appearance shifts** where an appearance-similarity baseline does not: 60.3% vs 36.5% against 33% chance over a 3-adapter library, with a baseline that fails degenerately rather than narrowly.
